...
if os.path.exists("source/ShipporiMincho.glyphs"):

    path = os.path.abspath("source/ShipporiMincho.glyphs")
    doc = Glyphs.openDocumentWithContentsOfFile_display_(path, False)
    font = doc.font()


    for instance in font.instances():
        print ("["+instance.familyName()+" "+instance.name()+"] Exporting")
    ...
    print ("Cannot find source file. Please confirm it has been unzipped")